...
// Global variables
	...
	$(function () {
		...
		//		dotsContainer: true,//c.attr("data-pagination-container") || false,
		//		navContainer: true,//c.attr("data-navigation-container") || false,
		//		mouseDrag: isNoviBuilder ? false : c.attr("data-mouse-drag") !== "false",
		//		nav: true,
		//		navigation: true,
		//		dots: true,//c.attr("data-dots") === "true",
		...
		//		navClass: function () {
		//			try {
		//				// JSON.parse(c.attr("data-nav-class"));
		//				console.log("NamVA vao");
		//				return ['owl-prev', 'owl-next'];
		//			} catch (e) {
		//				return ['owl-prev', 'owl-next'];
